...
type Config struct {
	...
	// process_include: when non-empty, only capture events for processes
	// whose executable matches one of these patterns (wildcards supported)
	ProcessInclude []string `json:"process_include,omitempty"`
